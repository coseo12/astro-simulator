...
> **P8+ 로드맵 v2 박제 위치**: `project_p8_p16_roadmap.md` (개인 메모리 초안 — 정식 문서화본: [roadmap-v2-solar-precision.md](../deprecated/phases/roadmap-v2-solar-precision.md), 개인 절대 경로 링크 제거 #842)
