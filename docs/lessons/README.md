...
| [operational-friction.md](operational-friction.md) | 반복 운영 마찰 4건 원인+절차 — squash auto-close 미발동(default branch만) / --delete-branch worktree 충돌 / pgrep self-match bracket `[-]` / concurrency CANCELLED 코스메틱 판별 + 릴리스 부수 마찰 | [#795](https://github.com/coseo12/astro-simulator/issues/795) (프로젝트) |
