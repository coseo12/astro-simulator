...
- [#1226](https://github.com/coseo12/astro-simulator/issues/1226) **야간 도시 불빛** (트랙 A) — 표면 셰이더 혼입 (ADR `20260628-756` Amendment 11). 아래 §후보 에서 이동했다. 릴리스 확정 뒤 §완료 로 옮긴다 (위 규칙).
...
> 제거된 행 4건: **야간 도시 불빛** → [#1226](https://github.com/coseo12/astro-simulator/issues/1226) 로 착수 (위 §진행 중) / **바다 깊이색** → [#1197](https://github.com/coseo12/astro-simulator/issues/1197) 로 착수·완료 (v0.86.0) / **대기 fresnel rim** → [#1202](https://github.com/coseo12/astro-simulator/issues/1202) 로 착수·완료 (v0.87.0) / **구름 레이어** → [#1215](https://github.com/coseo12/astro-simulator/issues/1215) 로 착수·완료 (v0.88.0). 뒤의 셋은 위 §완료 표로 이동했다 — 같은 낱말이 §완료 에 남아 있는 것은 정상이다.
