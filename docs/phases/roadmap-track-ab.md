...
- **없음** (2026-09-13 기준). 직전 착수분 [#1215](https://github.com/coseo12/astro-simulator/issues/1215) 는 위 §완료 로 이동했다.
...
| 후보             | ADR 앵커 (재검토 조건)                                                                                                                                                                   |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 야간 도시 불빛   | [ADR 20260628-756](../decisions/20260628-756-procedural-planet-surface.md) §A10.14 재검토 조건 5 — #1215 의 자식 shell · 정렬 키 치환 · 가시성 파생 재사용 여부 판정 (§A3.7 조건 3 잔여) |
...
> 제거된 행 3건: **바다 깊이색** → [#1197](https://github.com/coseo12/astro-simulator/issues/1197) 로 착수·완료 (v0.86.0) / **대기 fresnel rim** → [#1202](https://github.com/coseo12/astro-simulator/issues/1202) 로 착수·완료 (v0.87.0) / **구름 레이어** → [#1215](https://github.com/coseo12/astro-simulator/issues/1215) 로 착수·완료 (v0.88.0). 셋 다 위 §완료 표로 이동했다 — 같은 낱말이 §완료 에 남아 있는 것은 정상이다.
