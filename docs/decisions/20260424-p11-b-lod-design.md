...
| 자산                                                                                                    | 위치                                                                                                  | 본 설계 처리                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Tier` / `renderScaleForTier` (`resolveCurrentTier` 는 #845 에서 미사용 삭제)                           | `packages/core/src/scene/tier.ts`                                                                     | **읽기 전용 의존** — LOD 는 `activeTier` 를 참조하되 `setTier`/`Tier` 확장 금지 (Scale Tier ADR Prediction 1 계약)                                                         |
