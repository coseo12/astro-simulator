...
| 2026-08-14 | [982-changelog-tilde-guard](20260814-982-changelog-tilde-guard.md) | Provisional | prettier 소유 markdown (실측 5 파일) 에서 **bare `~~` 금지** + diff 스코프 fail-fast 가드 채택 — 취소선 필요 시 `<del>`. 209 커밋 시뮬레이션 precision `2/2`. 선행 ADR [`20260811-1010`](20260811-1010-measurement-c-verdict-tiers.md) (WARN 축을 **채택하지 않는** 근거 비교) |
