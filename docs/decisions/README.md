...
| 2026-08-06 | [962-branch-name-guard](20260806-962-branch-name-guard.md) | **Provisional** | 브랜치명 규약의 정본을 산문 3곳에서 실행 가능한 가드 상수로 이전 — CI 런타임 검사 + 산문 파생 정적 대조. #942 규약의 강제 수단 |
