# [DEPRECATED] Fact-First, Visual-Second — 프로젝트 원칙

> **Status**: **DEPRECATED (2026-04-25, roadmap reset)**
> **박제일**: 2026-04-20 (P10-A #268)
> **폐기일**: 2026-04-25
> **폐기 사유**: P12 Display-Relative Scale Unification 이 본 원칙의 1조 ("디폴트 UX 는 교육용 관례 유지") 를 폐기하면서 기본 화면이 빈 궤도 상태가 되는 UX 회귀 발생. 사용자 결정으로 "기획 의도 전면 폐기 + 현재 UI 기준 재구성 + 태양부터 하나씩" 접근으로 전환. 본 문서는 역사 참조용으로 보존.
> **신규 접근**: `docs/phases/roadmap-v3-incremental.md`
> **폐기 근거**: volt [#74](https://github.com/coseo12/volt/issues/74)
> **적용 범위**: 모든 Phase 의 데이터/시각/UI 설계 결정 ← **더 이상 적용되지 않음**
