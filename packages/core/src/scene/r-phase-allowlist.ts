 ...
 *
 * 현재 박제: CURRENT_R_PHASE=13 → sun(R1) / mercury(R2) / venus(R3) / earth·moon(R4)
 ...
 *           / oberon·proteus(R12 — 거성 위성 2, #725) = 32 body (천왕성·해왕성 2번째 위성, 거성 균형).
 *
...
export const CURRENT_R_PHASE = 13; // R12 #725 — 거성 위성 확장 2 (oberon/proteus) 자동 포함 (#613 자동 생성 9번째 실전. R11 후 신규 콘텐츠 라운드. ADR 20260621-725 §축 3)
