...
// R6 시점 satellite parent (earth=moon / mars=phobos·deimos / jupiter=galilean 4).
// R7+ 진입 시 갱신 (R_PHASE_BODY_ALLOWLIST 의 satellite parent 집합과 동기).
const EXPECTED_SATELLITE_PARENTS = ['earth', 'mars', 'jupiter'];
