...
const FOCUS_BUTTONS = [
  ...
  { id: 'halley', label: '핼리 혜성' }, // R10b #664 — PM Q2=A halley 만 승격 (showInShortcutBar true 전환 동반, #617 가드 정합). ⚠️ 배치 컨벤션: "행성 8 거리순 블록 + 비-행성 카테고리 후미 (pluto → halley)" — halley a=17.834 AU 를 saturn/uranus 사이 엄격 삽입하면 행성 거리순 블록이 깨져 기각 (ADR 20260612-r10b §축 6 — 후속 비-행성 추가 시 본 컨벤션 답습). 15버튼 — 모바일 overflow-x-auto 흡수. encke/swift-tuttle 은 showInShortcutBar=false (URL ?focus= 진입 — #624 tradeoff)
];
